...
class RouteingTestCase(TestCase):
    def test_branch(self):
        straight, points, branch_straight, mainline_straight = \
            Straight(layout=None), Points(layout=None), Straight(layout=None), Straight(layout=None)
    ...
    def test_branch_with_converge(self):
        straight, points_one, points_two, final_straight = \
            Straight(layout=None), Points(layout=None), Points(layout=None), Straight(layout=None)
