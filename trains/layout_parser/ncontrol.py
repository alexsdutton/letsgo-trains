...
from trains.layout_parser.base import LayoutFileParseException, LayoutParser
...
class NControlLayoutParser(LayoutParser):
    ...
    def parse(self, fp, layout: Layout):
        ...
        root = doc.getroot()
        if root.tag != 'data' or root.attrib.get('type') != 'nControl' or root.attrib.get('version') != '1':
